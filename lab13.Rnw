...
@
We preformed the randomization procedure which provides strong evidence to reject the null hypothesis as seen in part b of Question 3 with the p-values. 
